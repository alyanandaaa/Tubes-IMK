...
<body>
    ...
    <!--navbar artist start--->
    <section class="blog-section" id="artist">
            ...
            <div class="row artists-row">
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/1.jpg" alt="">
                        <h4>John Doe</h4>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/2.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/3.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/4.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/5.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/6.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/7.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 artists-col">
                    <div class="artists-item">
                        <img src="<?php echo base_url();?>assets/img/artists/8.jpg" alt="">
                        <h4>John Doe</h4>
                        <span>Photographer</span>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla pretium, vitae ornare leo sollicitudin. </p>
                    </div>
                ...
                <div class="col-lg-4 col-sm-12 artists-col">
                    <a class="artists-more-btn" href="<?php echo base_url();?>assets/#">
                        <img src="<?php echo base_url();?>assets/img/icons/arrow-big.png" alt="">
                    </a>
                </div>
            </div>
        </div>
